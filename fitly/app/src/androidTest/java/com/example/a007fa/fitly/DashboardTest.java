...
public class DashboardTest {
    ...
    public void testStepCount() {
        onView(withId(R.id.StepCountText)).check(matches(isDisplayed()));
    }

    @Test
    public void testScheduleText() {
        onView(withId(R.id.textView)).check(matches(withText("Today's schedule")));
    }
    ...
    public void testTitle() {
        onView(withId(R.id.header)).check(matches(withText("Dashboard")));
    }
